...
echo "################################################"
echo "  Running Mininet_VM Setup (mininet_vm2.sh)..."
echo "################################################"
...
setLogLevel('info')
net = Mininet()
red2 = net.addHost( 'red2', ip='10.0.0.2/8', mac='00:00:00:00:00:02' )
blue2 = net.addHost( 'blue2', ip='10.0.0.2/8', mac='00:00:00:00:00:02' )
s1 = net.addSwitch( 's1' )
